...
<head>
    ...
    <title>Transport IT Solutions
    </title>

    <!-- SEO Meta Tags -->
    <meta name="description"
        content="Aeologic integrates cutting-edge technology solutions with operational efficiency to deliver seamless and innovative solutions." />
...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    ...
    <main class="flex-grow">
        <div class="bg-gray-50">
            <section class="py-24 md:py-40 bg-cover bg-center text-white relative" aria-labelledby="key-service-page-title" style="background-image: linear-gradient(rgba(0, 50, 100, 0.6), rgba(0, 30, 70, 0.7)), url('https://via.placeholder.com/1200x400/1d4ed8/ffffff?text=Transport Sector');">
                ...
                <div class="container mx-auto px-6">
                    <nav aria-label="Breadcrumb" class="mb-10 text-sm text-gray-500">
                        <ol class="flex items-center space-x-2 flex-wrap">
                            ...
                            <li><span class="mx-1">/</span></li>
                            <li class="text-gray-700 font-medium truncate" aria-current="page" title="Transport Sector">Transport Sector 
                            </li>
                        </ol>
                    </nav>
                    <div class="max-w-5xl mx-auto bg-white p-6 md:p-10 rounded-xl shadow-2xl">
                        <div class="prose prose-lg lg:prose-xl max-w-none mb-12">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                Transport IT Solutions is at the forefront of revolutionizing the logistics and transportation industry. As a leading Transport Solutions Company, we integrate cutting-edge technology with operational efficiency to deliver seamless and innovative solutions. Our commitment to excellence ensures that our clients stay ahead in an ever-evolving transport landscape.
                            </p>
                        </div>
                        <div class="mb-12 p-6 bg-sky-50 rounded-lg border border-sky-200 shadow-lg">
                            ...
                            <div class="mt-4">
                                <button class="bg-sky-600 hover:bg-sky-700 text-white font-medium px-4 py-2 rounded shadow">
                                    Get Case-Study
                                </button>
                            </div>
                        </div>
                        <div class="mb-12 p-6 bg-emerald-50 rounded-lg border border-emerald-200 shadow-lg">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                Intelligent Traffic Management System is specially designed and architected to replace tedious manual processes to track, regulate and analyze vehicle movement on roads, and to enforce traffic rules for the safety of citizens and their properties.
                                <span class="block mt-2">
                                    It acts as a true decision support system for traffic planners and traffic law enforcement agencies—providing real-time data insights, improving law enforcement accuracy, and contributing to safer, smarter urban mobility.
                                </span>
                            </p>
                            ...
                            <div class="relative">
                                ...
                                <div class="flex md:items-center mb-8 md:mb-12 relative z-10 md:flex-row">
                                    ...
                                    <div class="flex-grow bg-white p-6 rounded-lg shadow-md border border-gray-200">
                                        <h4 class="text-lg font-semibold text-sky-700 mb-2">Road Accident Management System</h4>
                                ...
                                <div class="flex md:items-center mb-8 md:mb-12 relative z-10 md:flex-row-reverse">
                                    ...
                                    <div class="flex-grow bg-white p-6 rounded-lg shadow-md border border-gray-200">
                                        <h4 class="text-lg font-semibold text-sky-700 mb-2">Vehicle tracking system</h4>
                                        <p class="text-sm text-gray-600 leading-relaxed">
                                ...
                                <div class="flex md:items-center mb-8 md:mb-12 relative z-10 md:flex-row">
                                    ...
                                    <div class="flex-grow bg-white p-6 rounded-lg shadow-md border border-gray-200">
                                        <h4 class="text-lg font-semibold text-sky-700 mb-2">Electronic toll collection system </h4>
                                        <p class="text-sm text-gray-600 leading-relaxed">
                        ...
                        <div class="text-center my-16">
                            <a href="#contact"><button class="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-12 py-4 rounded-lg shadow-xl text-lg transform hover:scale-105 transition-all duration-300" aria-label="Find Your Expert Talent Now">Transport Sector </button></a>
                        </div>
                        <div class="text-center mt-12 pt-8 border-t border-gray-300">
                            <button class="text-sky-600 hover:text-sky-700 font-medium" aria-label="Back to Extend Your Technical Manpower">← <a href="#">Transport Sector </a></button>
                        </div>
