...
<head>
    ...
    <title>Logistics IT Solutions</title>

    <!-- SEO Meta Tags -->
    <meta name="description"
        content="Aeologic Logistics IT solutions offers simple and effective tech tools to help businesses run smoother." />
 ...
 @include('partials.nav')
    <main class="flex-grow">
        <div class="bg-gray-50">
            <section class="py-24 md:py-40 bg-cover bg-center text-white relative" aria-labelledby="key-service-page-title" style="background-image: linear-gradient(rgba(0, 50, 100, 0.6), rgba(0, 30, 70, 0.7)), url('https://via.placeholder.com/1200x400/1d4ed8/ffffff?text=Logistics Sector');">
                ...
                <div class="container mx-auto px-6">
                    <nav aria-label="Breadcrumb" class="mb-10 text-sm text-gray-500">
                        <ol class="flex items-center space-x-2 flex-wrap">
                            ...
                            <li><span class="mx-1">/</span></li>
                            <li class="text-gray-700 font-medium truncate" aria-current="page" title="Logistic IT Solutions">Logistic IT Solutions
                            </li>
                        </ol>
                    </nav>
                    <div class="max-w-5xl mx-auto bg-white p-6 md:p-10 rounded-xl shadow-2xl">
                        <div class="prose prose-lg lg:prose-xl max-w-none mb-12">
                            ...
                            <p class="text-gray-700 leading-relaxed">
                                As an expert in the field, Logistic IT Solutions offers simple and effective tech tools to help businesses run smoother. Being a top Logistic Solutions Company, we focus on giving our clients the best tools to handle their shipping and storage needs. Working with us means getting the right help to make your business grow and succeed.
                            </p>
                        </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="flex md:items-center mb-8 md:mb-12 relative z-10 md:flex-row">
                                    ...
                                    <div class="flex-grow bg-white p-6 rounded-lg shadow-md border border-gray-200">
                                        <h4 class="text-lg font-semibold text-sky-700 mb-2">Fleet & Asset Management</h4>
                        ...
                        <div class="text-center my-16">
                            <a href="#contact"><button class="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-bold px-12 py-4 rounded-lg shadow-xl text-lg transform hover:scale-105 transition-all duration-300" aria-label="Find Your Expert Talent Now">Logistic IT Solutions</button></a>
                        </div>
                        <div class="text-center mt-12 pt-8 border-t border-gray-300">
                            <button class="text-sky-600 hover:text-sky-700 font-medium" aria-label="Back to Extend Your Technical Manpower">← <a href="#">Logistic IT Solutions</a></button>
                        </div>
